  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 rounded-lg border border-surface-glass-border px-3 py-2 text-sm font-medium text-foreground transition-all duration-300 hover:border-primary/40 hover:shadow-[var(--shadow-glow-sm)]"
      >
